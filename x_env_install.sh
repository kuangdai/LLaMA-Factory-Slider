...
cp vllm-slider/vllm/model_executor/models/qwen3.py $VLLM_DIR/model_executor/models/qwen3.py
cp vllm-slider/vllm/model_executor/models/registry.py $VLLM_DIR/model_executor/models/registry.py
